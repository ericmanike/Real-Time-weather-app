...
function Layout() {
  return (<>
    <div className='w-full h-[120px] bg-[#071d44] text-[14px] md:text-1xl text-white flex flex-row flex-nowrap justify-between items-center gap-20  px-5 md:px-15 '>

        <FaCloudMoon className='text-[gold] h-16 w-16' />
